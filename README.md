1)	Objective of this project is to perform data cleaning, transformation, normalization and data analysis on Netflix dataset using PostgreSQL.
2)	Downloaded the dataset using Kaggle API.
